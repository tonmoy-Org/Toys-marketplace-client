        ...
        <div className='mt-52 mb-32 max-w-screen-xl mx-auto space-y-20 px-4'>
            ...
            <div className='lg:flex gap-10'>
                ...
                <div className='mt-10 space-y-4 mb-16' data-aos="fade-left"
                    ...
                    <button className="btn btn-wide rounded-none bg-[#004e96]">Learn To Fly</button>
                </div>
            </div>
            <div className='lg:flex gap-10'>
                ...
                <div className='mt-10 space-y-4 mb-10'
                    ...
                    <button className="btn btn-wide rounded-none bg-[#004e96]">Get Started</button>
                </div>
                <img src={ex2} alt="" />
            </div>
            <div className='lg:flex gap-10'>
                ...
                <div className='mt-10 space-y-4'
                    ...
                    <button className="btn btn-wide rounded-none bg-[#004e96]">Learn More</button>
                </div>
            </div>
        </div>
    );
