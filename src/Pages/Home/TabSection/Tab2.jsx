...
const Tab2 = ({ toy2 }) => {
    const { _id, toy_name, img, price, rating } = toy2;
    ...
    return (
        <div className="my-8" data-aos="flip-up"
        data-aos-duration="1500">
            <div className="card card-compact lg:w-96 w-4/5 mx-auto  h-[450px] bg-base-100 shadow-xl rounded-none">
